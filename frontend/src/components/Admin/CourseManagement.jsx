              ...
              <tbody className="divide-y divide-gray-700">
                {filteredCourses.map((course) => (
                  ...
                  >
                    ...
                    <td className="px-3 sm:px-4 lg:px-6 py-4 whitespace-nowrap text-xs sm:text-sm text-gray-200">
                    ...
                    <td className="px-3 sm:px-4 lg:px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="text-green-400 hover:text-green-300 p-2 rounded-lg hover:bg-green-900 hover:bg-opacity-20 transition-all duration-200 hover:scale-110"

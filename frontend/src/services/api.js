...
export const adminDashboardAPI = {
  ...
  // Get all student results for management
  getAllResults: async () => {
    return await adminApiCall("/results");
  },
  ...
  updateResult: async (resultId, resultData) => {
    return await adminApiCall(`/results/${resultId}`, {
      method: "PUT",
      body: JSON.stringify(resultData),
    });
  },
  ...
  getCoursesForResults: async () => {
    return await adminApiCall("/courses-for-results");
  },
};
